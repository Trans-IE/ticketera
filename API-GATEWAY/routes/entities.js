...
/**
 * @openapi
 * /api/entities/updateHoliday/{id}:
 *   put:
 *     summary: Actualización de un feriado en el sistema
 *     description: Este endpoint permite a un usuario con credenciales válidas actualizar un feriado existente en el sistema.
 *     tags: [Holidays]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *                 holiday:
 *                   type: object
 *                   description: Información del feriado.
 *       201:
 *         description: Actualización no permitida (201) debido a validaciones.
 *         content:
 *           application/json:
