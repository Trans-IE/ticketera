...
(async () => {
    try {
        ...
        await obfuscateAndSaveFolder('controllers', './obfuscate/controllers');
        await obfuscateAndSaveFolder('routes', './obfuscate/routes');
        await obfuscateAndSaveFolder('helpers', './obfuscate/helpers');
        await obfuscateAndSaveFolder('middlewares', './obfuscate/middlewares');
