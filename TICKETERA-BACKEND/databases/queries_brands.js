...
const createDBBrand = (id, nombre) => {
  const return_promise = new Promise((resolve, reject) => {
    pooldata.getPool.query(
      "select * from tickets.f_ticketera_brand_create($1, $2)",
      [id, nombre],
      (error, results) => {
        if (error) {
          reject(error.message);
...
const deleteDBBrand = (id) => {
  const return_promise = new Promise((resolve, reject) => {
    pooldata.getPool.query(
      "select * from tickets.f_ticketera_brand_delete($1)",
      [id],
      (error, results) => {
        if (error) {
          reject(error.message);
...
const updateDBBrand = (id, nombre, habilitado) => {
  const return_promise = new Promise((resolve, reject) => {
    pooldata.getPool.query(
      "select * from tickets.f_ticketera_brand_update($1,$2,$3)",
...
const getDBBrandsByCompany = (username, company) => {
  const return_promise = new Promise((resolve, reject) => {
    pooldata.getPool.query(
      "select * from tickets.f_ticketera_get_brands_by_company($1, $2);",
      [username, company],
      (error, results) => {
        if (error) {
          reject(error.message);
...
const getDBBrandsByContract = (username, contract) => {
  const return_promise = new Promise((resolve, reject) => {
    pooldata.getPool.query(
      "select * from tickets.f_ticketera_get_brands_by_contract($1, $2);",
      [username, contract],
      (error, results) => {
        if (error) {
          reject(error.message);
