...
router.post(
  ...
  [
    ...
    check("usuario", "El usuario debe tener al menos 8 caracteres").isLength({
      min: 8,
    }),
  ],
...
router.post(
  ...
  [
    ...
    check("sla_horas_respuesta", "sla_horas_respuesta es obligatorio")
      .not()
      .isEmpty(),
    check("sla_horas_provisorio", "sla_horas_provisorio es obligatorio")
      .not()
      .isEmpty(),
    check("sla_horas_definitivo", "sla_horas_definitivo es obligatorio")
      .not()
      .isEmpty(),
    ...
    check("reemplazo_partes", "reemplazo_partes es obligatorio")
      .not()
      .isEmpty(),
...
router.post(
  "/getResponsiblesByArea",
  [check("area_id", "Debe ingresar un area_id").not().isEmpty(), validarCampos],
