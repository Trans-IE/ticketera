...
import { Box, Button, CssBaseline, Divider, Drawer, FormControl, IconButton, InputLabel, List, MenuItem, Select, TextField, Toolbar } from '@mui/material';
        ...
        <div style={{ maxWidth: '1600px', height: '100vh', margin: ' 0 auto', padding: '25px 25px 25px 25px' }} >
            <div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    {/* Botones */}
                    <div>
                        <Button variant="contained" style={{ borderRadius: '20px' }}>Agregar Horas</Button>
                        <Button variant="contained" style={{ borderRadius: '20px', marginLeft: '10px' }}>Cargar Archivos</Button>
                        <Button variant="contained" style={{ borderRadius: '20px', marginLeft: '10px' }}>Editar Ticket</Button>
                        <Button variant="contained" style={{ borderRadius: '20px', marginLeft: '10px' }}>Soporte</Button>
                    </div>
                </div>
                    ...
                    <div style={{ backgroundColor: theme.palette.background.main, height: '80vh', width: '30%', borderRadius: '20px', border: '1px solid', borderColor: theme.palette.background.border, padding: '15px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between ' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', border: '1px solid', borderColor: theme.palette.background.border, borderRadius: '25px' }}>
                            <div style={{ padding: '10px', margin: '2px', width: '50%' }}>
                                ...
                                <div style={{ minHeight: '40px', paddingBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <LocalPhoneIcon fontSize='small' style={{ marginRight: '5px' }} />   3533-8895/3533-8892
                                </div>
                                <div style={{ minHeight: '40px', paddingBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <PlaceIcon fontSize='small' style={{ marginRight: '5px' }} />   Peru 553, CABA
                                </div>
                                <div style={{ minHeight: '40px', paddingBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <MailIcon fontSize='small' style={{ marginRight: '5px' }} />  soporte@prosegur.com
                                </div>
                            </div>
                            <div style={{ padding: '10px', margin: '2px', width: '50%' }}>
                                <div style={{ minHeight: '40px', paddingBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                ...
                                <div style={{ minHeight: '40px', paddingBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <LocalPhoneIcon fontSize='small' style={{ marginRight: '5px' }} />     <div className='selectState'> 11-5726-2888</div>
                                </div>
                                <div style={{ minHeight: '40px', paddingBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <PlaceIcon fontSize='small' style={{ marginRight: '5px' }} />  <div className='selectState'>Peru 553, CABA</div>
                                </div>
                                <div style={{ minHeight: '40px', paddingBottom: '10px', overflow: 'hidden', textOverflow: 'ellipsis', display: 'flex', alignItems: 'center' }}>
                                    <MailIcon fontSize='small' style={{ marginRight: '5px' }} /> <div className='selectState'> alejandro.noguera@ext.prosegur.com</div>
                                </div>
                            </div>
                        </div>
                    </div>
